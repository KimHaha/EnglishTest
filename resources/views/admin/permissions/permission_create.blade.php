        ...
        <form action="{{ route('permissions.store') }}" method="post">
    		...
    		<div class="col-md-6">
				<div class="form-group">
					...
					<input name="name" class="form-control input-sm" placeholder="Name" maxlength="100"></div>
			</div>
    		...
    		<div class="col-md-6">
				<div class="form-group">
					...
					<input name="display_name" class="form-control input-sm" placeholder="Display Name" maxlength="100"></div>
			</div>
			</div>
    		...
    		<div class="col-md-6">
				<div class="form-group">
					...
					<input name="description" class="form-control input-sm" placeholder="Description" maxlength="100"></div>
			</div>
			</div>
