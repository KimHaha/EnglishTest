...
<body>
	  ...
	  <img src="img/logo-website.fw.png" alt="Edu Expression" class="img-responsive" />	    </h1> 
	    ...
	    <ul class="sf-menu clearfix list-unstyled">
	      	      ...
	      	      <li class="current-menu-item"><a href="Subjects"><span class="glyphicon glyphicon-th-large"></span>&nbsp;Đối tượng</a></li>
...
</div>        <form action="subjects/deleteall" name="deleteallfrm" id="SubjectDeleteallForm" method="post" accept-charset="utf-8"><div style="display:none;"><input type="hidden" name="_method" value="POST"/></div></div>
<div class="row">
    <div class="col-md-12">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered">
                        <tr>
                            ...
                            <th><a href="Subjects/index/sort:id/direction:desc">STT.</a></td>
                            <th><a href="Subjects/index/sort:subject_name/direction:desc" class="asc">Tên lĩnh vực</a></td>
                            <th>Thêm câu hỏi</td>
                            <th>Thao tác</td>
                        </tr>
                                                <tr>
                            <td><input type="hidden" name="data[Subject][id][]" id="DeleteCheckbox6_" value="0"/><input type="checkbox" name="data[Subject][id][]"  value="6" id="DeleteCheckbox6" class="chkselect"/></td>
                            <td>1</td>
                            <td>Tin học lớp 3</td>
...
<div class="widget">
<h5 class="widget-title">
Time <span>26-02-2018 10:42:21 AM</span>
</h4>
</div> 
</div> 
</div> 
